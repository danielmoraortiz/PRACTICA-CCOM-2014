<?php require_once('../../common/paciente_log.php'); ?>
<?php
...
mysql_select_db($database_medicina, $medicina);
$query_authstandar = "SELECT * FROM paciente_estandarizado";
$authstandar = mysql_query($query_authstandar, $medicina) or die(mysql_error());
$row_authstandar = mysql_fetch_assoc($authstandar);
$totalRows_authstandar = mysql_num_rows($authstandar);
?>
<?php
...
if (isset($_POST['user'])) {
  ...
  $MM_redirectLoginSuccess = "cuestionario_01.php";
  $MM_redirectLoginFailed = "loginfail.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_medicina, $medicina);
  
  $LoginRS__query=sprintf("SELECT user, password FROM paciente_estandarizado WHERE user= '$loginUsername' AND password= '$password'",
    GetSQLValueString($loginUsername, "-1"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $medicina) or die(mysql_error());
...
<p>&nbsp;</p>
  <table width="100%" border="0" cellspacing="2" cellpadding="2">
    <tr>
      ...
      <td width="90%"><span id="sprytextfield1">
      <label>
