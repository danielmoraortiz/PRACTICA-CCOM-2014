...
<table width="87%" border="1" id="tbl_01">
  ...
  <tr>
    <td width="480"><strong>History Finding(s)
        </strong>
    ...
    <td width="490" align="left"><strong>Physical Exam Finding(s)
      </strong>
...
<input name="" type="submit" value="Submit" />
    ...
    <div class="TabbedPanelsContent">
      <DIV id="tabs-2">
        ...
        <p>Instructions</p>
        <OL>
          <LI>Obtain a history pertinent to this patient's problem.   
          <LI>Perform a relevant physical exmaination (Do not perform a breast,   pelvic/genital, corneal reflex, or rectal examination).   
          <LI>Discuss your impressions and any initial plans with the patient.   
